...
mysql -e "DROP DATABASE IF EXISTS liquibaserunner; CREATE DATABASE liquibaserunner CHARACTER SET utf8 COLLATE utf8_general_ci; SET GLOBAL max_allowed_packet=100000000;" -h 127.0.0.1 -uroot -proot
